...
export default function ReasonsPage() {
  ...
  return (
    <div className="min-h-screen bg-[#fbc2eb] flex flex-col items-center justify-center p-6 relative font-serif">
      ...
      <button
        className="bg-[#c92a2a] hover:bg-[#a51d1d] text-white px-8 py-3 rounded-full font-bold shadow-xl transition-all active:scale-95 flex items-center gap-2"
